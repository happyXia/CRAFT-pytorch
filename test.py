...
parser.add_argument('--low_text', default=0.6, type=float, help='text low-bound score')
...
parser.add_argument('--test_folder', default='./test_code/', type=str, help='folder path to input images')
...
def test_net(net, image, text_threshold, link_threshold, low_text, cuda, poly, refine_net=None):
    ...
    # permute(tuple of python:ints) – The desired ordering of dimensions 维度变换函数
...
if __name__ == '__main__':
    ...
    for k, image_path in enumerate(image_list):
        ...
        bboxes, polys, score_text, det_scores = test_net(net, image, args.text_threshold, args.link_threshold, args.low_text, args.cuda, args.poly, refine_net)
        # boxes_1 = polys
    ...
    data.to_csv('./result/data.csv', sep = ',', na_rep='Unknown')
